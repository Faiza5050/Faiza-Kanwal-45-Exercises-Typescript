...
function show_magicians3(magicians_name3) {
    magicians_name3.forEach(magicians1 => console.log(magicians1));
}
function make_great3(magicians_name3) {
    return magicians_name3.map(magician1 => `"${magician1} The Great magician"`);
}
let magicians_name3 = ["David", "Amenica", "Horsburgh"];
let great_magicians3 = make_great3([...magicians_name3]);
