// Ex-12: Greetings: Start with the array you used in Exercise 11, but instead of just
...
let friendsNames : string[] = ["MAHA", "FAIZA", "USAMA", "AHMER", "AREESHA", "SHEREEN"];

friendsNames.forEach(friend => {
    console.log(`Hello ${friend}, Have a Good Day!`);
})
