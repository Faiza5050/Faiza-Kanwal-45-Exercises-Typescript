// Ex-34: Pizzas: Think of at least three kinds of your favorite pizza. Store these
...
let favorite_pizza : string[] = [ "Tandori Chicken", "Fajita", "Pepperoni" ];

for (let pizza1 of favorite_pizza){
    console.log(`I like ${pizza1} Pizza.`);
}
console.log(`\n"I am very crazy to eat Pizza.\nThere are some of my favorite flavour but I like the most is pepperoni pizza.\nI really love Pizza."`);
